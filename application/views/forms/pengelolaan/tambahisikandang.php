...
if($id){
	?>
	<form hx-post="<?= base_url('pengelolaan/data_kandang/tambahisikandang/'.$id) ?>" hx-target="#data">
		<div class="form-floating mb-3">
			<input type="date" name="tanggal_masuk" class="form-control" placeholder="Tanggal Masuk" required>
			<label>Tanggal Masuk</label>
		</div>
		<div class="form-floating mb-3">
			<input type="number" name="jumlah_masuk" class="form-control" placeholder="Tanggal Masuk" required>
