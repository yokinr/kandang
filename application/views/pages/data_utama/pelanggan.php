<div class="card">
	<div class="card-header">
		<button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" hx-post="<?= base_url('form/get/data_utama/tambahpelanggan') ?>" hx-target=".modal-body"><i class="fas fa-plus"></i> Tambah Data</button>
	</div>
	<div class="card-body">
		<?php
		if($pelanggan){
			...
			<table class="table table-sm table-bordered table-striped">
				...
				<tbody>
					<?php foreach ($pelanggan as $key => $value): $key++ ?>
						<tr>
							<td><?= $key ?></td>
							<td><?= $value->nama ?></td>
							<td><?= $value->email ?></td>
