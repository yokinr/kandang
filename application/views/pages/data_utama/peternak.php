					...
					<?php foreach ($peternak as $key => $value): $key++ ?>
						<tr>
							...
							<td>
								...
								<button class="btn btn-link text-danger" hx-post="<?= base_url('data_utama/data_peternak/hapus/'.$value->uniq) ?>" hx-target="#data" hx-confirm="Yakin ?"><i class="fas fa-trash"></i></button>
							</td>
						</tr>
					<?php endforeach ?>
				</tbody>
